...
ALLOWED_HOSTS = ['https://itgomel.herokuapp.com', '127.0.0.1']
...
WSGI_APPLICATION = 'itgomel.wsgi.application'
...
CACHES = {
    'default': {
        ...
        'LOCATION': os.path.join(BASE_DIR, 'itgomel_cache'),
    }
}
